...
-- 4.  Select the department of each employee with the employee number, last name, first name, and department
...
-- 6.  Select all employees in the sales department, employee number, last name, first name, and department name of all employees in the Sales department
...
-- 8.  Count the number of employees, grouped by last name, order by count
